...
| Low emphasis: For optional or supplementary actions with the least amount of prominence | [Connected button group](../m3/pages/button-groups/overview) | The connected button group shows multiple related options. Use it for changing the content visible on a page. | Walk, Bike, Drive |
