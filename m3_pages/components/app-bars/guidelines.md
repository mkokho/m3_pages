...
To boost visibility of a primary action, change the  of the icon button to filled or tonal, and consider using a wide icon button.
...
- A menu icon, which opens a modal 
...
The headline’s typography size and  change depending on the app bar variant.
...
Headline typography  for each app bar
...
Subtitle typography  for each app bar:
...
If changing the icon button color  to filled or tonal, only use one icon button.
