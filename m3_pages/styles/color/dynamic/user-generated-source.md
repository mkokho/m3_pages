...
The easiest way to do this is by using a color scheme generated by the 

Material Theme Builder and focus on applying the color roles to your designs instead of particular hex values. Then you can use the Material Theme Builder to test how well the design functions across potential user-generated color options.
